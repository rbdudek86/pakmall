				...
				<form class="form-horizontal" id="modifyForm" action="/member/modify" method="post" style="padding:100px">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md">
								<input id="memb_id" name="memb_id" type="text" placeholder="" class="form-control input-md"
								required="" value="<c:out value="${vo.memb_id}"/>">
						...
						<div class="form-group">
							...
							<div class="col-md">
								<input id="memb_name" name="memb_name" type="text" placeholder="" class="form-control input-md" 
								required=""  value="<c:out value="${vo.memb_name}"/>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md">
								<input id="memb_phone" name="memb_phone" type="text"
									...
									required="" value="<c:out value="${vo.memb_phone}"/>">
						...
						<div class="form-group">
							...
							<div class="col-md">
								<input id="memb_email" name="memb_email" type="email"
									placeholder="user@domain.com" class="form-control input-md" value="<c:out value="${vo.memb_email}"/>">
							</div>
						</div>
