		    			 ...
		    			 <table class="table table-striped">
						  ...
						  <c:forEach items="${user_list }" var="userVO" varStatus="status" >
						    <tr>
						      ...
						      <th scope="row"><input type="text" value="${userVO.user_zip }"></th>
						      <th scope="row"><input type="text" value="${userVO.user_addr1 }"></th>
						      <th scope="row"><input type="text" value="${userVO.user_addr2 }"></th>
						    </tr>
						   </c:forEach>
